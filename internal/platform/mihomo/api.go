...
func NewClient(controller string, secret string, httpClient *http.Client) (*Client, error) {
...
func (c *Client) SelectProxy(ctx context.Context, groupName string, proxyName string) error {
	if groupName == "" {
...
func (c *Client) TestProxyDelay(ctx context.Context, proxyName string, testURL string, timeoutMS int) (*DelayResponse, error) {
	if proxyName == "" {
...
func (c *Client) doJSONURL(ctx context.Context, method string, endpoint *url.URL, in any, out any) error {
	var body io.Reader
	if in != nil {
...
func (c *Client) endpoint(escapedPath string) (*url.URL, error) {
