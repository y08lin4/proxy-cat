...
func TestNewClientRequiresLocalhost(t *testing.T) {
	if _, err := NewClient("http://example.com:9090", "", nil); err == nil {
		t.Fatal("NewClient() error = nil, want non-localhost error")
	}
}
